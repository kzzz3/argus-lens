...
class FriendRequestUseCasesTest {
    ...
    fun accept_refreshesFriendsRequestsAndConversationThreads() = runBlocking {
        ...
        val useCases = FriendRequestUseCases(friendRepository, conversationRepository)

        val result = useCases.accept(
            requestId = "request-1",
    ...
    fun ignore_failureKeepsSnapshotAndReportsError() = runBlocking {
        ...
        val useCases = FriendRequestUseCases(
