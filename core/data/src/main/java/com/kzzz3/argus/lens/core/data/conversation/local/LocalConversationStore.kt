package com.kzzz3.argus.lens.core.data.conversation.local

import android.content.Context
import com.kzzz3.argus.lens.core.data.conversation.ConversationRepository
import com.kzzz3.argus.lens.core.data.conversation.applyLocalMessageStatus
import com.kzzz3.argus.lens.core.data.conversation.clearConversationUnreadCount
import com.kzzz3.argus.lens.core.database.local.ArgusLensDatabase
import com.kzzz3.argus.lens.core.database.local.LocalConversationDao
import com.kzzz3.argus.lens.core.database.local.LocalConversationEntity
import com.kzzz3.argus.lens.core.database.local.LocalDraftAttachmentEntity
import com.kzzz3.argus.lens.core.database.local.LocalMessageEntity
...
internal class LocalConversationStore(
                ...
                InboxConversationThread(
                    ...
                    draftAttachments = row.draftAttachments
                        ...
                        .map { attachment ->
                            ChatDraftAttachment(
                                id = attachment.id,
                                kind = ChatDraftAttachmentKind.valueOf(attachment.kind),
...
private fun createLocalConversationStore(
    context: Context,
...
internal fun createLocalConversationRepository(
    context: Context,
) : ConversationRepository {
