...
private fun createLocalAuthRepository(): AuthRepository {
    return LocalAuthRepository()
}

private fun createRemoteAuthRepository(): AuthRepository {
...
private class UnavailableAuthRepository : AuthRepository {
