...
import com.kzzz3.argus.lens.core.datastore.payment.WalletDetailsCache
import com.kzzz3.argus.lens.core.datastore.payment.WalletSummaryCache
...
internal class CachedPaymentRepository(
...
internal fun createCachedWalletSummary(
    receipt: PaymentReceipt,
    currentAccountId: String,
    currentDisplayName: String,
): WalletSummary? {
