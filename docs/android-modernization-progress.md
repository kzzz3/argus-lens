...
- Route action binding changes must also keep `EntryRouteRuntimeTest`, `ContactsRouteRuntimeTest`, `WalletRouteRuntimeTest`, `WalletActionRouteRuntimeTest`, and `RealtimeConnectionRuntimeTest` green.
