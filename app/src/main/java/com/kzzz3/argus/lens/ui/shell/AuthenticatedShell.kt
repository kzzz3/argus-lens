...
private val TopLevelDestinations = listOf(
    TopLevelDestination(AppRoute.Inbox, "Chats", Icons.Rounded.ChatBubble),
    TopLevelDestination(AppRoute.Contacts, "Contacts", Icons.Rounded.People),
    TopLevelDestination(AppRoute.Wallet, "Wallet", Icons.Rounded.AccountBalanceWallet),
    TopLevelDestination(AppRoute.Me, "Me", Icons.Rounded.Person),
)
            ...
            TopLevelDestinations.forEach { destination ->
                ...
                Surface(
                    ...
                    Column(
                        ...
                        Surface(
                            shape = CircleShape,
                            color = if (selected) ImGreen else if (destination.route == AppRoute.Wallet) ImAvatarMint else ImAvatarBlue,
                        ) {
