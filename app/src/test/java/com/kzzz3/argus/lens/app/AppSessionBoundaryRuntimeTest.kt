...
class AppSessionBoundaryRuntimeTest {
    @Test
    fun applySuccessfulAuthResultResetsRuntimeStateAndPublishesAuthenticatedSession() = runBlocking {
        ...
        val runtime = AppSessionBoundaryRuntime(
        ...
        runtime.applySuccessfulAuthResult(
    ...
    private suspend fun AppSessionBoundaryRuntime.applySuccessfulAuthResult(
        authResult: AuthRepositoryResult.Success,
