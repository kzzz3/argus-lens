...
class AppPersistenceRuntimeTest {
    @Test
    fun persistSessionAndConversationThreadsDelegatesThroughShellCoordinator() = runBlocking {
        val sessionRepository = FakeSessionRepository()
        val conversationRepository = FakeConversationRepository()
        val runtime = AppPersistenceRuntime(
        ...
        runtime.persistSession(session, credentials)
        runtime.persistConversationThreads(
            session = session,
